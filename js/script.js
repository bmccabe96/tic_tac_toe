...
const gameController = (() => {
    ...
    const checkForWinner = () => {
        ...
        if (board[0] === board[1] && board[0] === board[2] && board[0] !== "") {winnerFound(); return;}
        else if (board[0] === board[3] && board[0] === board[6] && board[0] !== "") {winnerFound(); return;}
        else if (board[0] === board[4] && board[0] === board[8] && board[0] !== "") {winnerFound(); return;}
        else if (board[1] === board[4] && board[1] === board[7] && board[1] !== "") {winnerFound(); return;}
        else if (board[2] === board[5] && board[2] === board[8] && board[2] !== "") {winnerFound(); return;}
        else if (board[2] === board[4] && board[2] === board[6] && board[2] !== "") {winnerFound(); return;}
        else if (board[3] === board[4] && board[3] === board[5] && board[3] !== "") {winnerFound(); return;}
        else if (board[6] === board[7] && board[6] === board[8] && board[6] !== "") {winnerFound(); return;}
        if (!board.includes("")){tie(); return;}
    }
